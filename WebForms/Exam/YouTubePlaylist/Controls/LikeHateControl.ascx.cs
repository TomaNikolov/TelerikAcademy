namespace YouTubePlaylist.Controls
{
    ...
    using YouTubePlaylist.Services;
    using Models;
    ...
    {
      //  public ILikesServices LikesServices { get; set; } = new LikesServices(new GenericRepository<Like>(new YouTubePlaylistDbContext()));
